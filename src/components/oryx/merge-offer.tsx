...
export default function MergeOffer() {
  const { mergeOffer, setMergeOffer } = useOryx();
      ...
      {mergeOffer && (
        ...
        >
          <motion.div
            ...
            animate={{ scale: 1, y: 0 }}
            exit={{ scale: 0.9, y: 20 }}
            className="glass-strong w-full max-w-sm overflow-hidden rounded-3xl border border-violet-500/40 shadow-2xl shadow-black/60"
          >
