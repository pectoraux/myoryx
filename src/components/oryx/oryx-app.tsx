...
/**
 * OryxApp — the full Oryx mobility experience (map + header + bottom sheet +
 * intro + merge offer logic). Extracted verbatim from the previous
 * `src/app/page.tsx` so the auth gating wrapper can swap it in once a session
